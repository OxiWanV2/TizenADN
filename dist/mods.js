(() => {
  ...
  (function() {
    ...
    if (window.tizen && window.tizen.tvinputdevice) {
      try {
        ...
        console.log("[ADN] Touches t\xE9l\xE9commande enregistr\xE9es");
      } catch (e) {
    ...
    function refreshFocusable() {
      focusableElements = Array.from(document.querySelectorAll(FOCUSABLE_SELECTORS)).filter((el) => {
        const rect = el.getBoundingClientRect();
        return rect.width > 0 && rect.height > 0;
      });
    }
    function applyFocus(index) {
      document.querySelectorAll(".__adn_focused").forEach((el2) => {
        el2.classList.remove("__adn_focused");
        el2.style.outline = "";
        el2.style.transform = "";
        el2.style.zIndex = "";
      });
    ...
    * { cursor: none !important; }
    ...
    /* Am\xE9lioration lisibilit\xE9 sur grand \xE9cran */
    body {
  ...
  `;
    ...
    console.log("[ADN TizenBrew] Module charg\xE9 \u2705");
  })();
})();
